...
- Sample: fixed 10-document validation subset
- Sampling seed: 1205
...
| End-to-end | Supported-subset LIR F1 | 0.0000 |
| End-to-end | Official full KILE F1 | 0.0000 |
| End-to-end | Official full LIR F1 | 0.0000 |
| End-to-end | Official full KILE AP | 0.0000 |
| End-to-end | Official full LIR AP | 0.0000 |
| Precomputed OCR | Supported-subset KILE F1 | 0.0000 |
| Precomputed OCR | Supported-subset LIR F1 | 0.0000 |
| Precomputed OCR | Official full KILE F1 | 0.0000 |
| Precomputed OCR | Official full LIR F1 | 0.0000 |
| Precomputed OCR | Official full KILE AP | 0.0000 |
| Precomputed OCR | Official full LIR AP | 0.0000 |
